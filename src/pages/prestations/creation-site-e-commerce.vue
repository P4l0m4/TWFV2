...
useHead(() => {
  return {
    title: 'Création de site e-commerce sur mesure | Tekila Web Factory',
    meta: [
      {
        hid: 'description',
        name: 'description',
        content: 'Nous créons votre site e-commerce sur mesure rapides et optimisé pour le référencement naturel (SEO)',
      },
    ],
  }
})
