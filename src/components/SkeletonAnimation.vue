...
.eye-shadow-left {
  left: 20%;
  animation: faceX1 0.7s 1s forwards, faceX2 0.7s 1.8s ease-out forwards, faceX3 0.7s 2.7s forwards;
}

.eye-right,
.eye-shadow-right {
  right: 20%;
  animation: faceX1 0.7s 1s forwards, faceX2 0.7s 1.8s forwards, faceX3 0.7s 2.7s ease-out forwards;
}
...
.nose {
  ...
  z-index: 1;
  animation: faceX1 0.7s 1s forwards, faceX2 0.7s 1.8s forwards, faceX3 0.7s 2.7s forwards;
}
...
.hand-left .arm {
  animation: armRotate1 0.3s 1s forwards, armRotate2 0.3s 1.4s forwards, armRotate3 0.3s 1.8s forwards,
    armRotate6 0.3s 3.4s forwards, armRotate7 0.3s 3.8s forwards;
}

.hand-right .arm {
  animation: armRotate4 1.2s 1.8s forwards, armRotate5 0.3s 3s forwards;
}

.hand-left .arm-below-container {
  animation: forearmRotate1 0.3s 1s forwards, forearmRotate2 0.3s 1.4s forwards, forearmRotate3 0.3s 1.8s forwards,
    forearmRotate6 0.3s 3.4s forwards, forearmRotate7 0.3s 3.8s forwards;
}

.hand-right .arm-below-container {
  animation: forearmRotate4 1.2s 1.8s forwards, forearmRotate5 0.3s 3s forwards;
}
...
.shadow::before {
  ...
  animation: shadowWidth1 0.3s 1s forwards, shadowWidth2 0.3s 1.4s forwards, shadowWidth3 0.3s 1.8s forwards,
    shadowWidth6 0.3s 3.4s forwards, shadowWidth7 0.3s 3.8s forwards, shadowWidth8 0.4s 4s forwards;
}

.shadow::after {
  left: 50%;
  border-radius: 0 1rem 1rem 0;
  animation: shadowWidth4 1.2s 1.8s forwards, shadowWidth5 0.3s 3s forwards, shadowWidth9 0.4s 4s forwards;
}
